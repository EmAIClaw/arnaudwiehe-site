...
export const speakingEvents: SpeakingEvent[] = [
  ...
  },
  {
    ...
    status: 'upcoming',
    metaDescription: 'Arnaud Wiehe at Next IT Security Benelux 2026 on AI and cybersecurity.',
    summary: '<p>Regional security conference exploring AI\'s impact on cybersecurity operations and defense strategies in the Benelux region.</p>',
